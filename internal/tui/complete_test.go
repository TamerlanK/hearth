...
func TestCandidates(t *testing.T) {
	...
	tests := []struct {
		...
		{"an at-sign tags a user", "hey @b", 6, 4, []string{"@bill", "@bob"}},
		{"an at-sign alone offers the room tags too", "@", 1, 0, []string{"@all", "@bill", "@bob", "@carol", "@here"}},
		{"a room tag completes", "@a", 2, 0, []string{"@all"}},
